      ...
      <div className="container mx-auto">
        ...
        <div className="grid grid-rows-2 grid-cols-9 gap-4">
          <div
            ...
            <Link to="/details/living-room" className="stretched-link">
              {/* <!-- fake children --> */}
            </Link>
          </div>
          <div className="relative col-span-9 row-span-1 md:col-span-2 md:row-span-2 card">
            ...
            <Link to="/details/children-room" className="stretched-link">
              {/* <!-- fake children --> */}
            </Link>
          </div>
          <div className="relative col-span-9 row-span-1 md:col-span-3 md:row-span-2 card">
            ...
            <Link to="/details/decoration" className="stretched-link">
              {/* <!-- fake children --> */}
            </Link>
          </div>
          <div className="relative col-span-9 row-span-1 md:col-span-4 card">
            ...
            <div className="overlay left-0 top-0 bottom-0 flex justify-center flex-col pl-48 md:pl-72">
              <h5 className="text-lg font-semibold">Master Room</h5>
              <span className="">837 items</span>
            </div>
            <Link to="/details/master-room" className="stretched-link">
              {/* <!-- fake children --> */}
            </Link>
          </div>
        </div>
